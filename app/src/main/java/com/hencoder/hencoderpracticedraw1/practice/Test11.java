...
public class Test11 extends View {
    ...
    public Test11(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Test11(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
